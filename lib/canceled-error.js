...
const isLikeCanceledError = (thing) => thing[_isCanceledError] ||
  getTag(thing.constructor) === 'CanceledError' ||
...
const CanceledError= class CanceledError extends Error {
    ...
    constructor(message, code = E_REASON_CANCELED, priority= 0, forced= false) {
        super();
        this.name = getTag(this.constructor);
    ...
    static isCanceledError(thing, ...codes) {
        return thing && (thing instanceof this || isLikeCanceledError(thing) && warnVersionInteraction(thing)) &&
