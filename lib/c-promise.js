        ...
        return {
            ...
            finisher(constructor) {
                ...
                Object.getOwnPropertyNames(prototype).forEach(prop => {
                    ...
                    let decoratedMethod, preparedMethod;
                    ...
                    if (isGeneratorFunction(method)) {
                        preparedMethod = context.promisify(method, {
                            scopeArg: isComponentDidMount || isComponentWillUnmount
                        });
                    } else if (isComponentWillUnmount || context.isPromisifiedFn(method)) {
                    ...
                    if(preparedMethod) {
                        if (isComponentWillUnmount) {
                            decoratedMethod = function () {
                                ...
                                return preparedMethod.apply(this, arguments);
                            }
                        } else if (isComponentDidMount || subscribeAll) {
                            decoratedMethod = function () {
                    ...
                    if (bind && !reactProtoMethods[prop] && bindAll ||
                      (eventHandlerRE.test(prop) ? bindListeners : bindMethods)) {
                        const targetFn = decoratedMethod || method;
                        descriptors[prop] = {
                            get() {
                                const context= this;
                                return function lazilyBoundListener() {
                                    return targetFn.apply(isContextDefined(this) ? this : context || this, arguments);
                                }
                            },
                            configurable: true
                        }
