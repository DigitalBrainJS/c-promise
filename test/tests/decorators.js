...
module.exports = {
  "should support async decorator": async function () {
    const klass = _decorate(null, function (_initialize) {
      class klass {
        constructor() {
          _initialize(this);
        }
  ...
  "should support listen & cancel decorators": async function () {
    ...
    const klass = _decorate(null, function (_initialize2) {
      class klass {
        constructor() {
          _initialize2(this);
        }
  ...
  "should support timeout, innerWeight, label decorators": async function () {
    ...
    const klass = _decorate(null, function (_initialize3) {
      class klass {
        constructor() {
          _initialize3(this);
        }
      ...
      return {
        ...
        d: [{
          kind: "method",
          decorators: [label('test'), innerWeight(2), timeout(500), async],
          key: "generator",
          value: function* generator(x) {
            const y = yield delay(1000, 123);
            return x + y;
